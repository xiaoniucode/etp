...
public class TransportProtocolConverter implements AttributeConverter<TransportProtocol, Integer> {
    ...
    @Override
    public Integer convertToDatabaseColumn(TransportProtocol protocol) {
        if (protocol == null) {
            return null;
        }
    ...
    @Override
    public TransportProtocol convertToEntityAttribute(Integer code) {
        return TransportProtocol.fromCode(code);
    }
}
