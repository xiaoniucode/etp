...
@Component
public class HttpConfigHandler implements ConfigHandler {
    private final InternalLogger logger= InternalLoggerFactory.getInstance(HttpConfigHandler.class);
    @Autowired
    ...
    @Override
    public RegisterResult handRegister(ProxyConfig config) throws EtpException {
    ...
    @Override
    public RegisterResult handReregister(ProxyConfig oldConfig, ProxyConfig newConfig, Diff diff) throws EtpException {
